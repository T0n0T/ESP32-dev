...
ui_Image1.set_src(ui_images.ui_img_602777530)
...
ui_Image1.set_angle(4)
ui_Image1.set_zoom(255)
ui_Image1.set_style_blend_mode( lv.BLEND_MODE.ADDITIVE, lv.PART.MAIN | lv.STATE.DEFAULT )
ui_Image1.set_style_opa( 130, lv.PART.MAIN | lv.STATE.DEFAULT )

ui_Label2 = lv.label(ui_Screen1)
ui_Label2.set_text("13")
ui_Label2.set_width(lv.SIZE.CONTENT)	# 1
ui_Label2.set_height(lv.SIZE.CONTENT)   # 1
ui_Label2.set_y(-40)
ui_Label2.set_x(lv.pct(-20))
ui_Label2.set_align( lv.ALIGN.CENTER)
ui_Label2.set_style_text_color( lv.color_hex( 0x23EBFF ), lv.PART.MAIN | lv.STATE.DEFAULT )
ui_Label2.set_style_text_opa( 255, lv.PART.MAIN| lv.STATE.DEFAULT )
ui_Label2.set_style_text_font( lv.font_montserrat_48, lv.PART.MAIN | lv.STATE.DEFAULT )

ui_Label1 = lv.label(ui_Screen1)
ui_Label1.set_text("27")
ui_Label1.set_width(lv.SIZE.CONTENT)	# 1
ui_Label1.set_height(lv.SIZE.CONTENT)   # 1
ui_Label1.set_y(-40)
ui_Label1.set_x(lv.pct(20))
ui_Label1.set_align( lv.ALIGN.CENTER)
ui_Label1.set_style_text_color( lv.color_hex( 0x23EBFF ), lv.PART.MAIN | lv.STATE.DEFAULT )
ui_Label1.set_style_text_opa( 255, lv.PART.MAIN| lv.STATE.DEFAULT )
ui_Label1.set_style_text_font( lv.font_montserrat_48, lv.PART.MAIN | lv.STATE.DEFAULT )
...
ui_Label3.set_y(-40)
ui_Label3.set_x(lv.pct(0))
ui_Label3.set_align( lv.ALIGN.CENTER)
ui_Label3.set_style_text_color( lv.color_hex( 0x23EBFF ), lv.PART.MAIN | lv.STATE.DEFAULT )
ui_Label3.set_style_text_opa( 255, lv.PART.MAIN| lv.STATE.DEFAULT )
ui_Label3.set_style_text_font( lv.font_montserrat_48, lv.PART.MAIN | lv.STATE.DEFAULT )
